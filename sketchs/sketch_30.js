// Variation 30 :  Dernier ajustement pour centrer le tout (DX)
let NP=520, PI = Math.PI;
let K1=11,N=32,K=16,H=5,R1=NP*.36,R=NP*.14,RR=.9;
let DX=NP/2,DY=NP/1.8,A1=-PI/6,AD=0; // DX ramené à NP/2
let CX,CY,R2,R3;
