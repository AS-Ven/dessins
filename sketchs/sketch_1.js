// Variation 1 : Augmentation légère de K1 (nombre de branches principales)
let NP=480, PI = Math.PI;
let K1=6,N=32,K=16,H=5,R1=NP*.36,R=NP*.14,RR=.9; // K1 changé de 5 à 6
let DX=NP/2,DY=NP/2,A1=0,AD=0;
let CX,CY,R2,R3;

// ----------------------------------------------------

K1=6 // Changé ici aussi pour cohérence avec le bloc de réassignation
N=19
K=13
H=30
R1=NP*.8
