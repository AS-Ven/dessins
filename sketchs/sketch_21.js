// Variation 21 : Augmentation de K pour plus de complexité par étoile
let NP=520, PI = Math.PI;
let K1=9,N=32,K=16,H=5,R1=NP*.36,R=NP*.14,RR=.9;
let DX=NP/2.2,DY=NP/1.8,A1=-PI/6,AD=PI/4;
let CX,CY,R2,R3;
